...
var _puppeteer = __webpack_require__(2);
    ...
    return _regeneratorRuntime2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.next = 10;
            return page.goto('https://www.ivanti.com/resources/patch-tuesday', { waitUntil: 'domcontentloaded' });

          case 10:
            _context.next = 12;
            return page.waitForSelector('.items.recorded-list.row');

          case 12:
            _context.next = 14;
            return page.$('.items.recorded-list.row > .item .details');
